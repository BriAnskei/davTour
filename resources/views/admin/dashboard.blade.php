...
<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
    ...
    <div class="bg-white rounded-2xl p-5 card-shine border border-slate2 relative overflow-hidden">
        ...
        <div class="flex items-center justify-between mb-3">
            ...
            <span class="text-xs font-semibold px-2 py-0.5 rounded-full" style="background:#d6ece0; color:#1a3a2a;">Tours</span>
        </div>
    ...
    <div class="bg-white rounded-2xl p-5 card-shine border border-slate2 relative overflow-hidden">
        ...
        <div class="flex items-center justify-between mb-3">
            ...
            <span class="text-xs font-semibold px-2 py-0.5 rounded-full" style="background:#f9e3bb; color:#a86d1e;">Schedules</span>
        </div>
    ...
    <div class="bg-white rounded-2xl p-5 card-shine border border-slate2 relative overflow-hidden">
        ...
        <div class="flex items-center justify-between mb-3">
            ...
            <span class="text-xs font-semibold px-2 py-0.5 rounded-full" style="background:#f5ede6; color:#8b5e3c;">Bookings</span>
        </div>
    ...
    <div class="rounded-2xl p-5 card-shine relative overflow-hidden text-white" style="background: linear-gradient(135deg, #1a3a2a 0%, #2d6a4f 100%);">
        ...
        <div class="flex items-center justify-between mb-3">
            ...
            <span class="text-xs font-semibold px-2 py-0.5 rounded-full bg-white/10 text-amber-200">Revenue</span>
        </div>
                    ...
                    <tr class="hover:bg-cream transition-colors">
                        ...
                        <td class="px-6 py-3">
                            ...
                            <span class="px-2 py-0.5 rounded-full text-xs font-semibold
                                {{ $s === 'confirmed' ? 'bg-jungle-100 text-jungle-700' : ($s === 'pending' ? 'bg-amber-100 text-amber-500' : 'bg-red-100 text-red-500') }}">
                                {{ ucfirst($s) }}
                            </span>
                        </td>
                    </tr>
